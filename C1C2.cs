...
namespace E_Appartments
{
    public partial class C1C2 : Form
    {
        public C1C2()
        {
            ...
            con.Open();
            SqlCommand Com1 = new SqlCommand("select * from Colombo_1 where ParkingID=2", con);
            ...
            con.Open();
            SqlCommand Com2 = new SqlCommand("select * from Colombo_1 where ParkingID=6", con);
        ...
        private void C1C2_Load(object sender, EventArgs e)
        {
