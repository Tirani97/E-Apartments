...
namespace E_Appartments
{
    public partial class MPC1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the '_E_AppartmentsDataSet16.Colombo_1' table. You can move, or remove it, as needed.
            this.colombo_1TableAdapter.Fill(this._E_AppartmentsDataSet16.Colombo_1);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (id > 0)
            {
                SqlCommand cmd = new SqlCommand("update Colombo_1 set Status=@Status where ParkingID=@id", con);
