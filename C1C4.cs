...
namespace E_Appartments
{
    public partial class C1C4 : Form
    {
        public C1C4()
        {
            ...
            con.Open();
            SqlCommand Com1 = new SqlCommand("select * from Colombo_1 where ParkingID=4", con);
            ...
            con.Open();
            SqlCommand Com2 = new SqlCommand("select * from Colombo_1 where ParkingID=8", con);
        ...
        private void C1C4_Load(object sender, EventArgs e)
        {
