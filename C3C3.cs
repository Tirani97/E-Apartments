...
namespace E_Appartments
{
    public partial class C3C3 : Form
    {
        public C3C3()
        {
            ...
            con.Open();
            SqlCommand Com1 = new SqlCommand("select * from Colombo_3 where ParkingID=3", con);
            ...
            con.Open();
            SqlCommand Com2 = new SqlCommand("select * from Colombo_3 where ParkingID=6", con);
        ...
        private void C3C3_Load(object sender, EventArgs e)
        {
