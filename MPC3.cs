...
namespace E_Appartments
{
    public partial class MPC3 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the '_E_AppartmentsDataSet18.Colombo_3' table. You can move, or remove it, as needed.
            this.colombo_3TableAdapter.Fill(this._E_AppartmentsDataSet18.Colombo_3);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (id > 0)
            {
                SqlCommand cmd = new SqlCommand("update Colombo_3 set Status=@Status where ParkingID=@id", con);
