...
namespace E_Appartments
{
    public partial class C3C1 : Form
    {
        public C3C1()
        {
            ...
            con.Open();
            SqlCommand Com1 = new SqlCommand("select * from Colombo_3 where ParkingID=1", con);
            ...
            con.Open();
            SqlCommand Com2 = new SqlCommand("select * from Colombo_3 where ParkingID=5", con);
        ...
        {
            this.Hide();
            LeaseRequestForm LRF1 = new LeaseRequestForm();
            LRF1.Show();
        }
    }
}
